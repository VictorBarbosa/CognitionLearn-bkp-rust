...
- Специальный пакет Unity ([`com.unity.cognition-learn`](https://github.com/Unity-Technologies/ml-agents/tree/main/com.unity.cognition-learn))
...
- Установить пакет `com.unity.cognition-learn` Unity
...
Далее см. [гайд про публикацию правок](https://github.com/Unity-Technologies/ml-agents/blob/main/com.unity.cognition-learn/CONTRIBUTING.md).

### Установка пакета `com.unity.cognition-learn` для Unity
...
Вы можете добавить самостоятельно com.unity.cognition-learn (из репозитория, который вы склонировали)
к вашему проекту:
1. `Меню Window` -> `Package Manager`.
1. В `Package Manaer` кликнете на кнопку “+”.
1. Выберите `Add package from disk`...
1. Зайдите в папку `com.unity.cognition-learn`
