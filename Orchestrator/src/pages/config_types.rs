...
impl AlgoConfig {
    ...
    pub fn ppo_ce() -> Self { Self { trainer_type: "ppo_ce".into(), learning_rate: 0.0003, learning_rate_schedule: "linear".into(), batch_size: 2048, buffer_size: 20480, buffer_init_steps: 0, tau: 0.95, steps_per_update: 1.0, save_replay_buffer: false, init_entcoef: None, beta: Some(0.01), epsilon: Some(0.2), lambd: Some(0.95), num_epoch: Some(3), policy_delay: None, n_quantiles: None, n_to_drop: None, destructive_threshold: None, max_grad_norm: Some(0.5), image_pad: None, entropy_temperature: None, adaptive_entropy_temperature: None, curiosity_strength: Some(0.01), curiosity_gamma: Some(0.99), curiosity_learning_rate: Some(0.0001), curiosity_hidden_units: Some(256), curiosity_num_layers: Some(2), imagination_horizon: Some(5), use_imagination_augmented: Some(true), normalize: true, hidden_units: 512, num_layers: 3, gamma: 0.995, strength: 1.0, max_steps: 500000000, summary_freq: 5000, checkpoint_interval: 5000, keep_checkpoints: 5, use_memory: false, memory_sequence_length: Some(128), memory_size: Some(256), time_horizon: 256 } }
